...
public class upload_song_file extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Part part = request.getPart("song");//        
        
        String fileName = System.currentTimeMillis() + "_" + extractFileName(part);//file name
        
        String savePath = "F:\\setup\\all\\project\\MusicSpot\\web\\files\\songs\\" + File.separator + fileName; //img file
        ...
        try {
            ...
            PreparedStatement addSongToArtistAccount = JOConnction.conn.prepareStatement("update songs SET song_file = '"+imgDBFileName+"' where song_id = '"+id+"' ");
